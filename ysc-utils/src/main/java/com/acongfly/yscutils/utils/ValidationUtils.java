...
public class ValidationUtils {
    ...
    /**
     * description: 校验单个属性值,当校验不满足时候，result的hasError值为true
     * <p>
    ...
    /**
     * description: 校验属性值，按照组校验 注意：传入的class必须是接口，如果指定了interface那么就只会校验指定group中的属性，其他不会校验。 *
     * 例如：group={example.class},那么就会只校验指定了group={example.class}的相关注解属性
     * <p>
     * param: [obj, classes]
     * <p>
     * return: com.ushareit.fintech.payment.common.utils.ValidationResult
     * <p>
     * author: shicong yang
     * <p>
     * date: 2019-04-12
