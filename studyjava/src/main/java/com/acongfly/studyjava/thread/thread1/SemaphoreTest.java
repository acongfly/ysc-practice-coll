 ...
 * @Description: Semaphore信号灯同步工具 在什么地方用呢？举个例子:当要有十个人去厕所的时候，但是只有五个坑，只能运行五个人用，然后谁先
 *               用完谁走，然后谁在接着用。(比较俗)另外等待的五个人可以是随机获取优先的机会，也可以是按照先来后到的顺序获得机会 这取决于构造semaphore对象时传入的参数选项
