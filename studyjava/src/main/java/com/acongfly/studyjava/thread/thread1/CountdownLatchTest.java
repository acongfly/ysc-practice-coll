 ...
 * @Description: countdownLatch可以理解为一个倒数的计数器，调用这个对象的countDown方法就将计数器减一，当计数器 减到0的时候，所有的等待者或者单个等待者就开始执行
 *               它可以实现一个人（也可以是多个人）等待其他所有人都来通知他，可以实现一个人通知多个人的效果，类似于裁判一声口令， 运动员就开始奔跑，或者所有的运动员跑到终点裁判才公布结果
