package com.acongfly.studyjava.thread.threadCountStimation;
 ...
 * description:线程池进行估算
 * <p>
 * param: https://github.com/sunshanpeng/dark_magic/blob/master/README.md
 * <p>
 * return:
 * <p>
 * author: shicong yang
...
public abstract class PoolSizeCalculator {
    ...
    private void calculateOptimalCapacity(BigDecimal targetQueueSizeBytes) {
        ...
        System.out.println(
            "createTask() produced " + createTask().getClass().getName() + " which took " + mem + " bytes in a queue");
        System.out.println("Formula: " + targetQueueSizeBytes + " / " + mem);
        System.out.println("* Recommended queue capacity (bytes): " + queueCapacity);
    }

    /**
     * Brian Goetz' optimal thread count formula, see 'Java Concurrency in * Practice' (chapter 8.2) * * @param cpu *
     * cpu time consumed by considered task * @param wait * wait time of considered task * @param targetUtilization *
    ...
    /**
     * * Runs the {@link Runnable} over a period defined in {@link #elapsed}. * Based on Heinz Kabbutz' ideas *
     * (http://www.javaspecialists.eu/archive/Issue124.html). * * @param task * the runnable under investigation
     */
