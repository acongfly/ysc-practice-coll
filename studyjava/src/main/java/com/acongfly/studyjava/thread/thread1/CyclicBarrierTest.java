 ...
 * @Description: CyclicBarrier此工具类的使用，类似于
 * 好几个人出去玩，约定一个地方集合，先来的人要等后面的人来齐了，一起出发。这个类就是这个集合的概念
                ...
                public void run() {
                    ...
                    try {
                        ...
                        System.out.println("线程：" + Thread.currentThread().getName() + "即将到达集合地点1，当前已有"
                                + (cyclicBarrier.getNumberWaiting() + 1) + "个已经到达，" + (cyclicBarrier.getNumberWaiting() == 2 ? "都到齐了，继续走" : "正在等候"));
                        cyclicBarrier.await();
