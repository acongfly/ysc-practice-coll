...
//        ExecutorService executor = Executors.newCachedThreadPool();
        ...
        Disruptor<OrderInfo> disruptor = new Disruptor<OrderInfo>(orderInfoFactory, ringBufferSize, orderInfoTreadFactory, ProducerType.SINGLE, new YieldingWaitStrategy());
        // 连接消费事件方法
