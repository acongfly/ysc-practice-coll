...
/**
 * program: study<p>
 * description: Rxjava学习<p>
 * author: shicong yang<p>
 * createDate: 2018-12-18 09:41<p>
 **/
...
//        Observable();  //被观察者
        ...
        People[] people = new People[]{new People("战三", 18, new String[]{"睡觉", "吃饭", "玩"}), new People("战四", 20, new String[]{"敲代码", "写代码", "调代码"})};
        //观察者
