...
public final class EnvelopeUtils {
     ...
     * @return
     */
    public static int randomBonusWithSpecifyBound(
            Integer totalBonus, Integer totalNum,
            Integer sendedBonus, Integer sendedNum, Integer rdMin, Integer rdMax, double bigRate) {
     ...
     * @param rdMax      随机上限
     */
    public static void checkEnvelopUnpack(
            EnvelopPrizeTypeEnum priceType,
            int totalBonus, int totalNum, int rdMin, int rdMax) {
