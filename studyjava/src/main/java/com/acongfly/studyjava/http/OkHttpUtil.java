...
// * 异步基于post的多文件上传
// */
// private void _postDataFileAsync(String url, final ResultCallback callback, File[] files, String[] fileKeys, Param...
// params) {
// Request request = buildMultipartFormRequest(url, files, fileKeys, params);
// deliveryResult(callback, request);
// }
...
// * @param map map
// */
// private void _upLoadImg(String url, final ResultCallback callback, File file, String fileKey, Map<String, String>
// map) {
