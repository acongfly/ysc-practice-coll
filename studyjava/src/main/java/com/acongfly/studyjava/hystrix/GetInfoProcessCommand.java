...
public class GetInfoProcessCommand extends HystrixCommand<String> {
    ...
    // }
    //
    // protected GetInfoCommand(HystrixCommandGroupKey group, HystrixThreadPoolKey threadPool, int
    ...
    private static Setter setter() {
        ...
        HystrixThreadPoolProperties.Setter threadPoolProperties = HystrixThreadPoolProperties.Setter().withCoreSize(10)
            .withMaxQueueSize(Integer.MAX_VALUE).withKeepAliveTimeMinutes(5).withQueueSizeRejectionThreshold(1000);
        ...
        return Setter.withGroupKey(groupKey).andCommandKey(commandKey).andCommandPropertiesDefaults(commandProperties)
            .andThreadPoolKey(hystrixThreadPoolKey).andThreadPoolPropertiesDefaults(threadPoolProperties);
